...
//	 private JLabel voltarLabel;
	...
	public TelaTutorial3(){
		...
		fundoInfo = new JLabel(new ImageIcon("Imagens//telaTutorial3.png"));
		fundoInfo.setBounds(0, 0, 500, 333);
		
		ImageIcon imagemC = new ImageIcon("Imagens//home.png");
